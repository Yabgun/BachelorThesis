...
|---|---|---|---|---|
| 64 | beyin MR, tümör maskesi | 0.0176 | 4.65e-06 | 1.13 |
| 64 | akciğer grafisi, akciğer maskesi | 0.2 | 6.7e-06 | 1.39 |
| 128 | beyin MR, tümör maskesi | 0.0175 | 9.17e-06 | 1.28 |
| 128 | akciğer grafisi, akciğer maskesi | 0.198 | 1.68e-05 | 1.58 |

| size | rho | ciphertext_sayisi | sifreli_slot | sifreleme_s | sunucu_s | toplam_s | hiz_kazanci_toplam | yukleme_MB |
|---|---|---|---|---|---|---|---|---|
| 64 | 0.009 | 1 | 64 | 0.011 | 1.089 | 1.116 | 1.348 | 0.856 |
| 64 | 0.048 | 1 | 256 | 0.010 | 1.472 | 1.504 | 1.000 | 0.855 |
| 64 | 0.098 | 1 | 512 | 0.017 | 2.067 | 2.107 | 0.714 | 0.855 |
| 64 | 0.250 | 1 | 1024 | 0.010 | 1.358 | 1.384 | 1.087 | 0.855 |
| 64 | 0.494 | 1 | 2048 | 0.010 | 1.456 | 1.481 | 1.016 | 0.855 |
| 64 | 0.739 | 1 | 4096 | 0.010 | 1.515 | 1.541 | 0.977 | 0.856 |
| 64 | 0.908 | 1 | 4096 | 0.010 | 1.497 | 1.522 | 0.989 | 0.856 |
| 64 | 1.000 | 1 | 4096 | 0.010 | 1.480 | 1.505 | 1.000 | 0.856 |
| 128 | 0.010 | 1 | 256 | 0.009 | 1.113 | 1.137 | 2.545 | 0.856 |
| 128 | 0.051 | 1 | 1024 | 0.009 | 1.291 | 1.316 | 2.200 | 0.856 |
| 128 | 0.098 | 1 | 2048 | 0.009 | 1.386 | 1.410 | 2.053 | 0.854 |
| 128 | 0.250 | 1 | 4096 | 0.010 | 1.498 | 1.523 | 1.901 | 0.856 |
| 128 | 0.505 | 2 | 8320 | 0.020 | 2.289 | 2.324 | 1.246 | 1.711 |
| 128 | 0.752 | 2 | 16384 | 0.020 | 2.845 | 2.881 | 1.005 | 1.712 |
| 128 | 0.894 | 2 | 16384 | 0.021 | 2.841 | 2.878 | 1.006 | 1.711 |
| 128 | 1.000 | 2 | 16384 | 0.021 | 2.859 | 2.895 | 1.000 | 1.712 |
| 256 | 0.010 | 1 | 1024 | 0.009 | 1.302 | 1.326 | 8.009 | 0.856 |
| 256 | 0.050 | 1 | 4096 | 0.010 | 1.486 | 1.511 | 7.026 | 0.856 |
| 256 | 0.100 | 1 | 8192 | 0.011 | 1.581 | 1.607 | 6.607 | 0.855 |
| 256 | 0.250 | 2 | 16384 | 0.021 | 2.856 | 2.892 | 3.671 | 1.712 |
| 256 | 0.500 | 4 | 32768 | 0.042 | 5.416 | 5.472 | 1.941 | 3.423 |
| 256 | 0.752 | 7 | 49408 | 0.069 | 8.744 | 8.828 | 1.203 | 5.989 |
| 256 | 0.901 | 8 | 59392 | 0.081 | 10.513 | 10.609 | 1.001 | 6.846 |
| 256 | 1.000 | 8 | 65536 | 0.081 | 10.523 | 10.619 | 1.000 | 6.846 |
| 512 | 0.010 | 1 | 4096 | 0.010 | 1.491 | 1.516 | 27.406 | 0.856 |
| 512 | 0.050 | 2 | 16384 | 0.021 | 2.858 | 2.894 | 14.355 | 1.711 |
| 512 | 0.100 | 4 | 26624 | 0.040 | 5.240 | 5.296 | 7.844 | 3.421 |
| 512 | 0.250 | 8 | 65536 | 0.081 | 10.600 | 10.697 | 3.884 | 6.844 |
| 512 | 0.500 | 16 | 131072 | 0.163 | 20.772 | 20.950 | 1.983 | 13.690 |
| 512 | 0.749 | 24 | 196608 | 0.244 | 31.030 | 31.289 | 1.328 | 20.541 |
| 512 | 0.901 | 29 | 237568 | 0.292 | 37.319 | 37.625 | 1.104 | 24.813 |
| 512 | 1.000 | 32 | 262144 | 0.324 | 41.204 | 41.543 | 1.000 | 27.383 |
...
| covidqu | goruntu_roi | 0 | 0.234 | 0.990 | 3.853 | 4.103 |
| covidqu | kanonik | 0 | 0.633 | 0.974 | 1.465 | 1.568 |
| covidqu | kanonik_genis8 | 0 | 0.795 | 0.957 | 1.136 | 1.250 |
| covidqu | kanonik_genis16 | 0 | 0.911 | 0.910 | 1.001 | 1.093 |
| covidqu | kanonik_genis32 | 0 | 0.996 | 0.681 | 1.000 | 1.004 |
| covidqu | kanonik_genis64 | 0 | 1.000 | 0.500 | 1.000 | 1.000 |
| covidqu | sizinti_gudumlu | 1 | 0.692 | 0.965 | 1.322 | 1.436 |
| covidqu | sizinti_gudumlu | 2 | 0.744 | 0.946 | 1.219 | 1.337 |
| covidqu | sizinti_gudumlu | 3 | 0.782 | 0.940 | 1.155 | 1.271 |
| covidqu | sizinti_gudumlu | 4 | 0.827 | 0.919 | 1.092 | 1.203 |
| covidqu | sizinti_gudumlu | 5 | 0.862 | 0.899 | 1.048 | 1.154 |
| covidqu | sizinti_gudumlu | 6 | 0.900 | 0.883 | 1.003 | 1.106 |
| covidqu | sizinti_gudumlu | 7 | 0.931 | 0.864 | 1.001 | 1.070 |
| covidqu | sizinti_gudumlu | 8 | 0.955 | 0.830 | 1.000 | 1.045 |
| covidqu | sizinti_gudumlu | 9 | 0.981 | 0.776 | 1.000 | 1.019 |
| covidqu | sizinti_gudumlu | 10 | 1.000 | 0.500 | 1.000 | 1.000 |
| covidqu | rastgele_0 | 2 | 0.721 | 0.966 | 1.263 | 1.379 |
| covidqu | rastgele_0 | 4 | 0.789 | 0.959 | 1.145 | 1.260 |
| covidqu | rastgele_0 | 6 | 0.866 | 0.948 | 1.042 | 1.149 |
| covidqu | rastgele_0 | 8 | 0.933 | 0.920 | 1.001 | 1.068 |
| covidqu | rastgele_0 | 10 | 1.000 | 0.500 | 1.000 | 1.000 |
| covidqu | rastgele_1 | 2 | 0.729 | 0.958 | 1.246 | 1.363 |
| covidqu | rastgele_1 | 4 | 0.809 | 0.950 | 1.116 | 1.229 |
| covidqu | rastgele_1 | 6 | 0.866 | 0.936 | 1.042 | 1.149 |
| covidqu | rastgele_1 | 8 | 0.937 | 0.895 | 1.001 | 1.064 |
| covidqu | rastgele_1 | 10 | 1.000 | 0.500 | 1.000 | 1.000 |
| brain | tamamen_gizli | 0 | 1.000 | 0.500 | 1.000 | 1.000 |
| brain | goruntu_roi | 0 | 0.016 | 0.941 | 7.859 | 24.206 |
| brain | kanonik | 0 | 0.334 | 0.910 | 2.827 | 2.940 |
| brain | kanonik_genis8 | 0 | 0.439 | 0.920 | 2.194 | 2.253 |
| brain | kanonik_genis16 | 0 | 0.550 | 0.918 | 1.730 | 1.804 |
| brain | kanonik_genis32 | 0 | 0.791 | 0.892 | 1.142 | 1.256 |
| brain | kanonik_genis64 | 0 | 1.000 | 0.619 | 1.000 | 1.000 |
| brain | sizinti_gudumlu | 1 | 0.396 | 0.910 | 2.412 | 2.488 |
| brain | sizinti_gudumlu | 2 | 0.457 | 0.896 | 2.111 | 2.164 |
| brain | sizinti_gudumlu | 3 | 0.516 | 0.901 | 1.867 | 1.921 |
| brain | sizinti_gudumlu | 4 | 0.568 | 0.900 | 1.664 | 1.747 |
| brain | sizinti_gudumlu | 5 | 0.623 | 0.893 | 1.492 | 1.593 |
| brain | sizinti_gudumlu | 6 | 0.672 | 0.889 | 1.367 | 1.477 |
| brain | sizinti_gudumlu | 7 | 0.720 | 0.892 | 1.264 | 1.380 |
| brain | sizinti_gudumlu | 8 | 0.778 | 0.872 | 1.162 | 1.278 |
| brain | sizinti_gudumlu | 9 | 0.841 | 0.859 | 1.074 | 1.183 |
| brain | sizinti_gudumlu | 10 | 0.884 | 0.842 | 1.021 | 1.125 |
| brain | sizinti_gudumlu | 11 | 0.946 | 0.859 | 1.000 | 1.054 |
| brain | sizinti_gudumlu | 12 | 0.996 | 0.811 | 1.000 | 1.004 |
| brain | sizinti_gudumlu | 13 | 1.000 | 0.500 | 1.000 | 1.000 |
| brain | rastgele_0 | 2 | 0.434 | 0.913 | 2.214 | 2.274 |
| brain | rastgele_0 | 4 | 0.529 | 0.916 | 1.810 | 1.873 |
| brain | rastgele_0 | 6 | 0.632 | 0.913 | 1.469 | 1.571 |
| brain | rastgele_0 | 8 | 0.736 | 0.894 | 1.233 | 1.351 |
| brain | rastgele_0 | 10 | 0.819 | 0.894 | 1.103 | 1.215 |
| brain | rastgele_0 | 12 | 0.938 | 0.862 | 1.001 | 1.063 |
| brain | rastgele_0 | 13 | 1.000 | 0.500 | 1.000 | 1.000 |
| brain | rastgele_1 | 2 | 0.424 | 0.909 | 2.263 | 2.328 |
| brain | rastgele_1 | 4 | 0.517 | 0.897 | 1.862 | 1.917 |
| brain | rastgele_1 | 6 | 0.622 | 0.886 | 1.496 | 1.596 |
| brain | rastgele_1 | 8 | 0.734 | 0.881 | 1.236 | 1.354 |
| brain | rastgele_1 | 10 | 0.850 | 0.878 | 1.062 | 1.170 |
| brain | rastgele_1 | 12 | 0.938 | 0.858 | 1.001 | 1.063 |
