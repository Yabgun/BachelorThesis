...
%\usepackage{colortbl} % MiKTeX'teki colortbl v1.0k, array v2.5g'de olmayan \insert@pcolumn'u kullaniyor; tezde renkli tablo yok
\usepackage{pstricks}
\usepackage{pst-plot}
\usepackage{cite}%
\usepackage{latexsym}           % 
...
\usepackage[turkish,shorthands=:!]{babel} % Türkçe bölüm, şekil vb. isimleri(denklemlerde sorun çıkartmaması için shorthands var)
