...
\textbf{Saldırı.} Sunucu, çözülmüş değerlerin ve elindeki şifreli metnin bilgisiyle şifreleme denklemini kurar. İki çözülmüş sonuç için yazılan denklemler, kanonik gömme kodlamasının çift doğrusal yapısı kullanılarak gizli anahtarın her katsayısı için doğrusal bir sisteme indirgenir. Gizli anahtar üçlü (ternary) olduğundan tek bir kalıntı sınıfı halkası (RNS) asalı yeterlidir. Uygulama yalnızca standart kütüphaneyle, \texttt{pilot/indcpad\_poc\_tenseal.py} betiğinde verilmiştir.
